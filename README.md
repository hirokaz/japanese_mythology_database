...
神社・神格・氏族の一覧/検索、20,010 件の関係探索、確実性レベル（L0–L5）の可視化ができます。
...
| モチーフ (motif) | 500 |
| 文献 (text) | 20 |
| 時代 / 社格 / イベント / 地域 | 22 / 15 / 26 / 347 |
| **関係 (relations)** | **20,010** |

KPI: L0 比率 66%、L4–L5 仮説 0.03%、dangling 参照 0、整合性 100%（`scripts/audit_kpi.py` で検証）。
...
│   └── README.md
├── docs/
│   ├── master/           # deity / shrine / clan / text / period / rank / event / region master (TSV)
│   ├── relations/        # relations.tsv（20,010 件）
