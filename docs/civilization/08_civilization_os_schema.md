...
## 13. relation 拡張 第4群: 考古・物質 50 種(S08)

考古遺跡・遺物・物的祭祀対象 の関係を 50 種拡張。既存 `:FOUND_AT`/`:DATED_TO`/`:ARCHAEOLOGICALLY_LINKED` 3 種を継承しつつ、層位・型式・伝来経路・対応神話を細分化。

### 13.1 一覧表(50 種)

| # | TSV relation_type | Cypher 写像 | source ラベル | target ラベル | directed |
|---|---|---|---|---|---|
| **13.1.1 site / artifact 詳細 10種** | | | | | |
| R191 | excavated_year | `:EXCAVATED_YEAR` | `:Site`/`:Artifact` | (year 文字列) | yes |
| R192 | stratified_above | `:STRATIFIED_ABOVE` | `:Artifact`/`:Site` | `:Artifact`/`:Site` | yes |
| R193 | contemporary_with_site | `:CONTEMPORARY_WITH_SITE` | `:Site` | `:Site` | undirected |
| R194 | site_extends_to | `:SITE_EXTENDS_TO` | `:Site` | `:Region` | yes |
| R195 | cultural_context_of | `:CULTURAL_CONTEXT_OF` | `:Site` | `:DynasticPeriod`/`:Cosmology` | yes |
| R196 | discovery_attribution | `:DISCOVERY_ATTRIBUTION` | `:Site`/`:Artifact` | `:Clan`/`:Event` | yes |
| R197 | site_named_after | `:SITE_NAMED_AFTER` | `:Site` | `:Region`/`:Deity` | yes |
| R198 | reused_for_burial | `:REUSED_FOR_BURIAL` | `:Site` | `:ImperialBurial` | yes |
| R199 | site_replaces | `:SITE_REPLACES` | `:Site` | `:Site` | yes |
| R200 | overlay_with_modern_shrine | `:OVERLAY_WITH_MODERN_SHRINE` | `:Site` | `:Shrine` | yes |
| **13.1.2 artifact class / type 10種** | | | | | |
| R201 | object_class_of | `:OBJECT_CLASS_OF` | `:Artifact` | `:MetalObjectClass`/`:RitualObjectClass` | yes |
| R202 | typological_predecessor | `:TYPOLOGICAL_PREDECESSOR` | `:MetalObjectClass` | `:MetalObjectClass` | yes |
| R203 | typological_successor | `:TYPOLOGICAL_SUCCESSOR` | `:MetalObjectClass` | `:MetalObjectClass` | yes |
| R204 | imported_artifact | `:IMPORTED_ARTIFACT` | `:Artifact` | `:Region`(外国) | yes |
| R205 | trade_origin_of | `:TRADE_ORIGIN_OF` | `:Artifact` | `:Region` | yes(産地推定) |
| R206 | local_imitation_of | `:LOCAL_IMITATION_OF` | `:Artifact` | `:Artifact` | yes |
| R207 | inscription_on | `:INSCRIPTION_ON` | (text content) | `:Artifact` | yes |
| R208 | dating_method_used | `:DATING_METHOD_USED` | `:Artifact`/`:Site` | (method 文字列) | yes |
| R209 | object_in_set | `:OBJECT_IN_SET` | `:Artifact` | `:Artifact`(set 代表) | yes |
| R210 | composite_object | `:COMPOSITE_OBJECT` | `:Artifact` | `:Artifact`(部品) | yes |
| **13.1.3 sacred object / mythic correspondence 10種** | | | | | |
| R211 | sacred_object_corresponds_to | `:SACRED_OBJECT_CORRESPONDS_TO` | `:SacredObject` | `:Artifact` | yes |
| R212 | mythic_weapon_object | `:MYTHIC_WEAPON_OBJECT` | `:MythicWeapon` | `:SacredObject`/`:Artifact` | yes |
| R213 | object_represents | `:OBJECT_REPRESENTS` | `:Artifact`/`:SacredObject` | `:Symbol`/`:Deity` | yes |
| R214 | mound_type_of | `:MOUND_TYPE_OF` | `:Site`/`:ImperialBurial` | `:MoundClass` | yes |
| R215 | mound_attributed_to | `:MOUND_ATTRIBUTED_TO` | `:ImperialBurial` | `:Emperor`/`:Clan` | yes |
| R216 | grave_goods_class | `:GRAVE_GOODS_CLASS` | `:Site`/`:ImperialBurial` | `:MetalObjectClass` | yes |
| R217 | sacred_stone_at_site | `:SACRED_STONE_AT_SITE` | `:SacredStone` | `:Site` | yes |
| R218 | sacred_tree_at_site | `:SACRED_TREE_AT_SITE` | `:SacredTree` | `:Site` | yes |
| R219 | sacred_cave_at_region | `:SACRED_CAVE_AT_REGION` | `:SacredCave` | `:Region` | yes |
| R220 | object_excavated_at | `:OBJECT_EXCAVATED_AT` | `:Artifact` | `:Site` | yes |
| **13.1.4 metal workshop / production 10種** | | | | | |
| R221 | workshop_at_site | `:WORKSHOP_AT_SITE` | `:MetalWorkshop` | `:Site` | yes |
| R222 | workshop_produced | `:WORKSHOP_PRODUCED` | `:MetalWorkshop` | `:MetalObjectClass` | yes |
| R223 | workshop_used_material | `:WORKSHOP_USED_MATERIAL` | `:MetalWorkshop` | (material 文字列) | yes |
| R224 | workshop_operated_by | `:WORKSHOP_OPERATED_BY` | `:MetalWorkshop` | `:Clan` | yes |
| R225 | workshop_period | `:WORKSHOP_PERIOD` | `:MetalWorkshop` | `:DynasticPeriod` | yes |
| R226 | technology_imported_from | `:TECHNOLOGY_IMPORTED_FROM` | `:MetalWorkshop` | `:Region`(渡来元) | yes |
| R227 | tatara_succession | `:TATARA_SUCCESSION` | `:MetalWorkshop` | `:MetalWorkshop` | yes(近世たたら継承) |
| R228 | metal_god_worshipped_at | `:METAL_GOD_WORSHIPPED_AT` | `:Deity`(金山彦/金屋子) | `:MetalWorkshop`/`:Shrine` | yes |
| R229 | smelting_innovation | `:SMELTING_INNOVATION` | `:MetalWorkshop` | `:MetalObjectClass` | yes |
| R230 | metal_trade_route | `:METAL_TRADE_ROUTE` | `:MetalObjectClass` | `:TradeRoute`/`:SeaLane` | yes |
| **13.1.5 archaeological linkage / mythology correspondence 10種** | | | | | |
| R231 | linked_to_myth | `:LINKED_TO_MYTH` | `:Site`/`:Artifact` | `:MythEpisode`/`:MotifAbstract` | yes |
| R232 | linked_to_deity | `:LINKED_TO_DEITY` | `:Site`/`:Artifact` | `:Deity` | yes |
| R233 | jomon_continuity | `:JOMON_CONTINUITY` | `:Site` | `:Ritual`/`:MotifAbstract` | yes(縄文連続性仮説) |
| R234 | yayoi_introduction | `:YAYOI_INTRODUCTION` | `:Site`/`:Artifact` | `:MotifAbstract`/`:MetalObjectClass` | yes |
| R235 | site_terminates | `:SITE_TERMINATES` | `:Site` | (year 範囲) | yes(銅鐸祭祀終焉 等) |
| R236 | site_supports_hypothesis | `:SITE_SUPPORTS_HYPOTHESIS` | `:Site` | `:Hypothesis` | yes |
| R237 | site_contradicts_hypothesis | `:SITE_CONTRADICTS_HYPOTHESIS` | `:Site` | `:Hypothesis` | yes |
| R238 | corresponds_to_chronicler | `:CORRESPONDS_TO_CHRONICLER` | `:Site`/`:Artifact` | `:Text` | yes |
| R239 | discovery_changed_view | `:DISCOVERY_CHANGED_VIEW` | `:Site`/`:Artifact` | `:Hypothesis` | yes |
| R240 | unesco_status | `:UNESCO_STATUS` | `:Site`/`:Pilgrimage` | (status 文字列: WHS/Tentative) | yes |

→ **R191-R240 で 50 種**(累計 190 + 50 = 240 種)

### 13.2 既存 relation との整合

| 既存 | 拡張との関係 |
|---|---|
| `:FOUND_AT` (artifact → site) | R220 `:OBJECT_EXCAVATED_AT` で重複が、既存を残し補完として共存 |
| `:DATED_TO` | R208 `:DATING_METHOD_USED` で **方法** を補完(炭素 14/AMS/層位/編年) |
| `:ARCHAEOLOGICALLY_LINKED` (site/artifact → myth_episode/deity) | R231 `:LINKED_TO_MYTH` / R232 `:LINKED_TO_DEITY` で **対象別に分離** |
| `:SUPPORTS` (hypothesis → 任意) | R236 `:SITE_SUPPORTS_HYPOTHESIS` で **site 起点版** を独立化 |
...
```
(SITE-加茂岩倉)-[:OBJECT_EXCAVATED_AT]<-(ART-銅鐸39個)
(ART-銅鐸39個)-[:OBJECT_CLASS_OF]->(MOC-銅鐸)
(MOC-銅鐸)-[:TYPOLOGICAL_PREDECESSOR]->(MOC-初期銅鐸)
(MOC-銅鐸)-[:LINKED_TO_MYTH]->(MTF-001 国譲り) ※L2 仮説
(SITE-加茂岩倉)-[:CULTURAL_CONTEXT_OF]->(DPD-弥生後期)
(SITE-加茂岩倉)-[:SITE_TERMINATES]->("CE 200頃")
(SITE-加茂岩倉)-[:SITE_SUPPORTS_HYPOTHESIS]->(HYP-004 銅鐸祭祀終焉⇄国譲り神話説)
```

#### Scenario B. 七支刀の inscription

```
(ART-七支刀)-[:OBJECT_EXCAVATED_AT]->(SITE-石上神宮)
(ART-七支刀)-[:INSCRIPTION_ON]<-("百済王世子奇生聖音 為倭王旨造")
(ART-七支刀)-[:DATED_TO]->("CE 369銘")
(ART-七支刀)-[:IMPORTED_ARTIFACT]->(REG-百済)
(ART-七支刀)-[:LINKED_TO_DEITY]->(DEI-布都御魂)
(ART-七支刀)-[:OBJECT_REPRESENTS]->(SYM-武威)
```

#### Scenario C. 奥出雲たたら継承

```
(MWK-奥出雲たたら)-[:WORKSHOP_AT_SITE]->(SITE-菅谷たたら)
(MWK-奥出雲たたら)-[:WORKSHOP_PRODUCED]->(MOC-玉鋼)
(MWK-奥出雲たたら)-[:WORKSHOP_OPERATED_BY]->(CLN-山内・絲原・桜井)
(MWK-奥出雲たたら)-[:METAL_GOD_WORSHIPPED_AT]<-(DEI-金屋子神)
(MWK-奥出雲たたら)-[:WORKSHOP_PERIOD]->(DPD-近世)
(MWK-奥出雲たたら)-[:TATARA_SUCCESSION]->(MWK-現代金屋子神社)
```

#### Scenario D. 沖ノ島祭祀(段階変遷)

```
(SITE-沖ノ島)-[:OVERLAY_WITH_MODERN_SHRINE]->(SHR-077 沖津宮)
(SITE-沖ノ島)-[:UNESCO_STATUS]->("WHS 2017")
(SITE-沖ノ島)-[:OBJECT_EXCAVATED_AT]<-(ART-神宝(銅鏡/勾玉/金製品))
(ART-神宝)-[:GRAVE_GOODS_CLASS]->(MOC-神獣鏡)
(SITE-沖ノ島)-[:LINKED_TO_DEITY]->(DEI-017 田心姫)
(SITE-沖ノ島)-[:CULTURAL_CONTEXT_OF]->(DPD-古墳〜平安期)
(SITE-沖ノ島)-[:SITE_SUPPORTS_HYPOTHESIS]->(HYP-沖ノ島対朝鮮ロジ説)
```
...
| S06 祭祀権力 | ✅ | 103 | 140 |
| S07 政治・支配 | ✅ | 103 | 190 |
| **S08 考古・物質** | **✅(本 PR)** | 103 | **240** |
| S09 時間・継承 | 未着手 | 103 | 240 → 290 |
| S10 仮説・解釈 | 未着手 | 103 | 290 → 340 |

---

## 14. relation 拡張 第5群: 時間・継承 50 種(S09)

時間軸(`#124` の 5 軸)に沿った **継承・先行・並行・断絶・更新** 関係を 50 種拡張。既存 `:VARIANT_OF` `:RENAMED_TO` `:SUPERSEDES` 等を継承しつつ、時間構造を関係化。

### 14.1 一覧表(50 種)

| # | TSV relation_type | Cypher 写像 | source ラベル | target ラベル | directed |
|---|---|---|---|---|---|
| **14.1.1 temporal precedence 10種** | | | | | |
| R241 | precedes | `:PRECEDES` | (任意) | (任意) | yes(時間的先行) |
| R242 | followed_by | `:FOLLOWED_BY` | (任意) | (任意) | yes |
| R243 | contemporary_with | `:CONTEMPORARY_WITH` | (任意) | (任意) | undirected |
| R244 | overlaps_period | `:OVERLAPS_PERIOD` | (任意) | (任意) | undirected |
| R245 | starts_at | `:STARTS_AT` | (任意) | `:RegnalEra`/`:DynasticPeriod`/(year) | yes |
| R246 | ends_at | `:ENDS_AT` | (任意) | `:RegnalEra`/`:DynasticPeriod`/(year) | yes |
| R247 | continued_until | `:CONTINUED_UNTIL` | (任意) | (year/era) | yes |
| R248 | active_during | `:ACTIVE_DURING` | (任意) | `:DynasticPeriod`/`:RegnalEra` | yes |
| R249 | dormant_during | `:DORMANT_DURING` | `:Shrine`/`:Ritual` | `:DynasticPeriod` | yes(衰退期) |
| R250 | revived_during | `:REVIVED_DURING` | `:Shrine`/`:Ritual` | `:DynasticPeriod` | yes(復活期) |
| **14.1.2 cultural inheritance 10種** | | | | | |
| R251 | inherited_from | `:INHERITED_FROM` | (任意) | (任意) | yes(広義の文化継承) |
| R252 | tradition_continues | `:TRADITION_CONTINUES` | `:Ritual`/`:Festival` | `:Ritual`/`:Festival` | yes |
| R253 | ritual_succession | `:RITUAL_SUCCESSION` | `:Ritual` | `:Ritual` | yes(同祭祀の世代継承) |
| R254 | shrine_succession | `:SHRINE_SUCCESSION` | `:Shrine` | `:Shrine` | yes(社地・祭祀の継承) |
| R255 | priestly_succession | `:PRIESTLY_SUCCESSION` | `:Clan`/`:PriestLineage` | `:Clan`/`:PriestLineage` | yes |
| R256 | technology_succession | `:TECHNOLOGY_SUCCESSION` | `:MetalObjectClass` | `:MetalObjectClass` | yes |
| R257 | text_succession | `:TEXT_SUCCESSION` | `:Text` | `:Text` | yes(後継書) |
| R258 | school_succession | `:SCHOOL_SUCCESSION` | `:ReligiousSchool` | `:ReligiousSchool` | yes |
| R259 | architectural_succession | `:ARCHITECTURAL_SUCCESSION` | `:ShrineArchitecture` | `:ShrineArchitecture` | yes |
| R260 | calendar_succession | `:CALENDAR_SUCCESSION` | `:CalendarSystem` | `:CalendarSystem` | yes |
| **14.1.3 textual / chronicle relation 10種** | | | | | |
| R261 | text_compiled_by | `:TEXT_COMPILED_BY` | `:Text` | `:Clan`/`:Emperor` | yes |
| R262 | text_commissioned_by | `:TEXT_COMMISSIONED_BY` | `:Text` | `:Emperor` | yes(勅撰) |
| R263 | text_quotes | `:TEXT_QUOTES` | `:Text` | `:Text` | yes |
| R264 | text_redacts | `:TEXT_REDACTS` | `:Text` | `:Text` | yes(校訂) |
| R265 | text_lost | `:TEXT_LOST` | `:Text` | (year) | yes(逸文化) |
| R266 | text_partial_remains | `:TEXT_PARTIAL_REMAINS` | `:Text` | (status) | yes |
| R267 | text_preserved_in | `:TEXT_PRESERVED_IN` | `:Text` | `:Text`(他書引用) | yes |
| R268 | text_describes_period | `:TEXT_DESCRIBES_PERIOD` | `:Text` | `:DynasticPeriod`/`:RegnalEra` | yes |
| R269 | text_written_during | `:TEXT_WRITTEN_DURING` | `:Text` | `:DynasticPeriod`/`:RegnalEra` | yes |
| R270 | text_genre_change | `:TEXT_GENRE_CHANGE` | `:Text` | `:SacredTextGenre` | yes |
| **14.1.4 cultural rupture / continuity 10種** | | | | | |
| R271 | discontinued_at | `:DISCONTINUED_AT` | `:Ritual`/`:Festival`/`:Shrine` | (year/era) | yes |
| R272 | reformed_at | `:REFORMED_AT` | `:Ritual`/`:Festival` | (year/era) | yes |
| R273 | merged_into_event | `:MERGED_INTO_EVENT` | `:Festival` | `:Festival` | yes |
| R274 | rebranded_as | `:REBRANDED_AS` | `:Shrine`/`:Festival`/`:Ritual` | `:Shrine`/`:Festival`/`:Ritual` | yes(明治神仏分離後 等) |
| R275 | banned_during | `:BANNED_DURING` | `:Ritual`/`:Festival` | `:DynasticPeriod`/`:RegnalEra` | yes |
| R276 | restored_after_meiji | `:RESTORED_AFTER_MEIJI` | `:Shrine`/`:Festival` | (status) | yes |
| R277 | continued_through_meiji | `:CONTINUED_THROUGH_MEIJI` | (任意) | (status) | yes |
| R278 | jomon_to_yayoi_continuity | `:JOMON_TO_YAYOI_CONTINUITY` | `:Site`/`:Ritual` | `:Site`/`:Ritual` | yes |
| R279 | yayoi_to_kofun_continuity | `:YAYOI_TO_KOFUN_CONTINUITY` | `:Site`/`:Ritual` | `:Site`/`:Ritual` | yes |
| R280 | medieval_to_modern_break | `:MEDIEVAL_TO_MODERN_BREAK` | (任意) | (任意) | yes(1872 神仏分離 等) |
| **14.1.5 prophecy / outcome / chain 10種** | | | | | |
| R281 | prophesied_in | `:PROPHESIED_IN` | `:Event`/`:Battle` | `:Oracle`/`:Omen` | yes |
| R282 | omen_precedes | `:OMEN_PRECEDES` | `:Omen` | `:Event`/`:MythEpisode` | yes |
| R283 | curse_consequence | `:CURSE_CONSEQUENCE` | `:Curse` | `:Event` | yes |
| R284 | retribution_for | `:RETRIBUTION_FOR` | `:Curse`/`:Event` | `:Event`/`:Battle` | yes |
| R285 | ritual_response_to | `:RITUAL_RESPONSE_TO` | `:Ritual` | `:Curse`/`:Event` | yes(祟り鎮め祭) |
| R286 | era_ushers | `:ERA_USHERS` | `:RegnalEra` | `:DynasticPeriod` | yes |
| R287 | reform_chain | `:REFORM_CHAIN` | `:PoliticalReform` | `:PoliticalReform` | yes |
| R288 | reign_chain | `:REIGN_CHAIN` | `:Emperor` | `:Emperor` | yes(代替り) |
| R289 | shrine_history_event | `:SHRINE_HISTORY_EVENT` | `:Shrine` | `:Event` | yes(造営/焼失/再建) |
| R290 | period_transitioned_via | `:PERIOD_TRANSITIONED_VIA` | `:DynasticPeriod` | `:Event`/`:Battle`/`:PoliticalReform` | yes |

→ **R241-R290 で 50 種**(累計 240 + 50 = 290 種)

### 14.2 既存 relation との整合

| 既存 | 拡張との関係 |
|---|---|
| `:VARIANT_OF` | 本書 R74 `:PLACE_SPECIFIC_VARIANT` で空間軸補完(S05)、本章では時間軸の `:PRECEDES` `:CONTEMPORARY_WITH` を独立化 |
| `:RENAMED_TO` | R274 `:REBRANDED_AS` で **改称の動機**(明治神仏分離 等)を分離 |
| `:SUPERSEDES` | 既存。本書では追加せず |
| `:TRIGGERED` (myth_episode/event → myth_episode/event) | R290 `:PERIOD_TRANSITIONED_VIA` で **時代遷移因果** を独立化 |

### 14.3 主要利用シナリオ

#### Scenario A. 1872 神仏分離令の文化的断絶

```
(EVT-神仏分離令1872)-[:PERIOD_TRANSITIONED_VIA]->(DPD-近代)
(SHR-諏訪上社)-[:REBRANDED_AS {era:明治}]->(SHR-諏訪上社_新)
(FES-八幡大菩薩祭)-[:DISCONTINUED_AT]->("CE 1872")
(SHR-牛頭天王社)-[:REBRANDED_AS]->(SHR-八坂神社)
(MTF-神仏習合)-[:MEDIEVAL_TO_MODERN_BREAK]->(MTF-国家神道)
(RIT-本地垂迹儀礼)-[:BANNED_DURING]->(RGE-明治)
```

#### Scenario B. 縄文→弥生→古墳の連続性仮説

```
(SITE-諏訪縄文)-[:JOMON_TO_YAYOI_CONTINUITY]->(SITE-諏訪弥生)
(RIT-縄文木柱列)-[:JOMON_TO_YAYOI_CONTINUITY]->(RIT-弥生柱建て)
(RIT-縄文柱建て)-[:TRADITION_CONTINUES]->(RIT-諏訪御柱祭)
(MTF-縄文蛇神)-[:JOMON_TO_YAYOI_CONTINUITY]->(MTF-弥生銅鐸蛇文)
(SITE-井戸尻)-[:CONTEMPORARY_WITH_SITE]->(SITE-尖石)
```

#### Scenario C. 編纂事業の連鎖

```
(TXT-古事記)-[:TEXT_COMPILED_BY]->(CLN-太安万侶)
(TXT-古事記)-[:TEXT_COMMISSIONED_BY]->(EMP-元明天皇)
(TXT-古事記)-[:PRECEDES]->(TXT-日本書紀)
(TXT-日本書紀)-[:TEXT_COMPILED_BY]->(EMP-舎人親王)
(TXT-日本書紀)-[:PRECEDES]->(TXT-続日本紀)
(TXT-続日本紀)-[:PRECEDES]->(TXT-日本後紀)
(TXT-古事記)-[:TEXT_DESCRIBES_PERIOD]->(DPD-神代〜推古朝)
(TXT-古事記)-[:TEXT_WRITTEN_DURING]->(RGE-和銅)
```

#### Scenario D. 大物主祟り → 崇神朝祭祀整備の因果連鎖

```
(OMN-疫病大流行)-[:OMEN_PRECEDES]->(EVT-祟り発覚)
(CRS-大物主祟り)-[:CURSE_CONSEQUENCE]->(EVT-疫病)
(RIT-大田田根子祭祀)-[:RITUAL_RESPONSE_TO]->(CRS-大物主祟り)
(RIT-大田田根子祭祀)-[:TRADITION_CONTINUES]->(RIT-現代大神神社祭)
(EVT-崇神朝祭祀整備)-[:PROPHESIED_IN]->(OMN-夢告)
(EVT-崇神朝祭祀整備)-[:PERIOD_TRANSITIONED_VIA]->(DPD-崇神朝)
```

#### Scenario E. 元号と天皇の連鎖

```
(EMP-天武天皇)-[:REIGN_CHAIN]->(EMP-持統天皇)
(RGE-朱鳥)-[:STARTS_AT]->("CE 686")
(RGE-朱鳥)-[:ERA_STARTED_BY]->(EMP-天武天皇)
(RGE-朱鳥)-[:ERA_USHERS]->(DPD-飛鳥期後半)
(RGE-大宝)-[:STARTS_AT]->("CE 701")
(RGE-大宝)-[:ERA_STARTED_BY]->(SLW-大宝律令)
(RGE-大宝)-[:ERA_WITHIN_PERIOD]->(DPD-飛鳥期末)
```
...
## 15. relation 拡張 第6群: 仮説・解釈 50 種(S10)

仮説層 L0-L5(`#124` 詳細)に対応し、**解釈・反証・代替仮説・出典評価** を細かく表現する関係を 50 種拡張。既存 `:SUPPORTS`/`:CONTRADICTS`/`:PROPOSED_BY` 3 種を継承しつつ、解釈の確度・対立構造・補強関係を独立化。

### 15.1 一覧表(50 種)

| # | TSV relation_type | Cypher 写像 | source ラベル | target ラベル | directed |
|---|---|---|---|---|---|
| **15.1.1 hypothesis structure 10種** | | | | | |
| R291 | hypothesis_layer | `:HYPOTHESIS_LAYER` | `:Hypothesis` | (L0-L5 文字列) | yes |
| R292 | hypothesis_about | `:HYPOTHESIS_ABOUT` | `:Hypothesis` | (任意 node) | yes(対象) |
| R293 | hypothesis_proposed_by | `:HYPOTHESIS_PROPOSED_BY` | `:Hypothesis` | `:Clan`/`:Text`/`:Emperor` | yes |
| R294 | hypothesis_extends | `:HYPOTHESIS_EXTENDS` | `:Hypothesis` | `:Hypothesis` | yes(発展系) |
| R295 | hypothesis_competes_with | `:HYPOTHESIS_COMPETES_WITH` | `:Hypothesis` | `:Hypothesis` | undirected |
| R296 | hypothesis_alternative_to | `:HYPOTHESIS_ALTERNATIVE_TO` | `:Hypothesis` | `:Hypothesis` | undirected |
| R297 | hypothesis_subset_of | `:HYPOTHESIS_SUBSET_OF` | `:Hypothesis` | `:Hypothesis` | yes |
| R298 | hypothesis_implies | `:HYPOTHESIS_IMPLIES` | `:Hypothesis` | `:Hypothesis` | yes |
| R299 | hypothesis_falsified_by | `:HYPOTHESIS_FALSIFIED_BY` | `:Hypothesis` | `:Site`/`:Artifact`/`:Text` | yes |
| R300 | hypothesis_status | `:HYPOTHESIS_STATUS` | `:Hypothesis` | (status: 主流/異端/未決/退潮) | yes |
| **15.1.2 evidence / interpretation 10種** | | | | | |
| R301 | interprets_as | `:INTERPRETS_AS` | `:Hypothesis` | (任意 node) | yes |
| R302 | reinterprets | `:REINTERPRETS` | `:Hypothesis` | `:Hypothesis` | yes |
| R303 | evidence_pro | `:EVIDENCE_PRO` | (任意 node) | `:Hypothesis` | yes(支持事実) |
| R304 | evidence_con | `:EVIDENCE_CON` | (任意 node) | `:Hypothesis` | yes(反証事実) |
| R305 | weak_evidence | `:WEAK_EVIDENCE` | (任意) | `:Hypothesis` | yes |
| R306 | strong_evidence | `:STRONG_EVIDENCE` | (任意) | `:Hypothesis` | yes |
| R307 | indirect_evidence | `:INDIRECT_EVIDENCE` | (任意) | `:Hypothesis` | yes |
| R308 | analogical_evidence | `:ANALOGICAL_EVIDENCE` | `:ComparativeMotif` | `:Hypothesis` | yes |
| R309 | folkloric_evidence | `:FOLKLORIC_EVIDENCE` | `:FolkMotif`/`:Ritual` | `:Hypothesis` | yes |
| R310 | textual_evidence | `:TEXTUAL_EVIDENCE` | `:Text` | `:Hypothesis` | yes |
| **15.1.3 academic / scholarly 10種** | | | | | |
| R311 | academic_consensus | `:ACADEMIC_CONSENSUS` | `:Hypothesis` | (status) | yes |
| R312 | minority_view | `:MINORITY_VIEW` | `:Hypothesis` | (status) | yes |
| R313 | scholarly_dispute | `:SCHOLARLY_DISPUTE` | `:Hypothesis` | `:Hypothesis` | undirected |
| R314 | superseded_hypothesis | `:SUPERSEDED_HYPOTHESIS` | `:Hypothesis` | `:Hypothesis` | yes |
| R315 | era_specific_view | `:ERA_SPECIFIC_VIEW` | `:Hypothesis` | `:DynasticPeriod`/`:RegnalEra` | yes(国学期/近代期 等) |
| R316 | scholar_proposed | `:SCHOLAR_PROPOSED` | `:Clan`(個人扱い) | `:Hypothesis` | yes(本居宣長/平田篤胤/折口信夫 等) |
| R317 | school_endorses | `:SCHOOL_ENDORSES` | `:ReligiousSchool` | `:Hypothesis` | yes |
| R318 | popular_belief | `:POPULAR_BELIEF` | `:Hypothesis` | (status) | yes(民間レベル) |
| R319 | tourism_narrative | `:TOURISM_NARRATIVE` | `:Hypothesis` | (status) | yes(観光向け解釈) |
| R320 | media_amplified | `:MEDIA_AMPLIFIED` | `:Hypothesis` | (status) | yes(現代メディア・小説経由) |
| **15.1.4 forgery / pseudohistory 10種** | | | | | |
| R321 | suspected_forgery | `:SUSPECTED_FORGERY` | `:Text` | (status) | yes |
| R322 | confirmed_forgery | `:CONFIRMED_FORGERY` | `:Text` | (status) | yes(東日流外三郡誌 等) |
| R323 | forgery_period | `:FORGERY_PERIOD` | `:Text` | `:DynasticPeriod`/`:RegnalEra` | yes(偽作期) |
| R324 | forgery_motive | `:FORGERY_MOTIVE` | `:Text` | (motive 文字列: 政治/宗教/商業) | yes |
| R325 | forgery_influences_belief | `:FORGERY_INFLUENCES_BELIEF` | `:Text` | `:Hypothesis`/`:FolkMotif` | yes |
| R326 | pseudohistory_supported_by | `:PSEUDOHISTORY_SUPPORTED_BY` | `:Hypothesis`(L5) | `:Text` | yes |
| R327 | mistakenly_attributed | `:MISTAKENLY_ATTRIBUTED` | `:Text`/`:Artifact` | `:Clan`/`:Emperor` | yes |
| R328 | retrofit_legend | `:RETROFIT_LEGEND` | `:MythVariant` | (era) | yes(後付け縁起) |
| R329 | shrine_legend_added_late | `:SHRINE_LEGEND_ADDED_LATE` | `:Shrine` | (era) | yes |
| R330 | popular_etymology | `:POPULAR_ETYMOLOGY` | `:Region`/`:Shrine`/`:Deity` | (status) | yes(俗解語源) |
| **15.1.5 confidence / temporal / strength 10種** | | | | | |
| R331 | confidence_level | `:CONFIDENCE_LEVEL` | (任意 relation) | (A-E 文字列) | yes(relation 自身のメタ) |
| R332 | temporal_scope | `:TEMPORAL_SCOPE` | (任意 relation) | (mythic/estimated/document/ritual/political/archaeological/literary) | yes |
| R333 | source_reliability | `:SOURCE_RELIABILITY` | `:Text` | (A-E) | yes |
| R334 | citation_strength | `:CITATION_STRENGTH` | `:Text` | (strength 文字列) | yes |
| R335 | mythology_layer | `:MYTHOLOGY_LAYER` | (任意 relation/node) | (L0-L5) | yes |
| R336 | historical_layer | `:HISTORICAL_LAYER` | (任意 relation/node) | (mythic/estimated/document) | yes |
| R337 | uncertainty_note | `:UNCERTAINTY_NOTE` | (任意 relation/node) | (note 文字列) | yes |
| R338 | confidence_revised | `:CONFIDENCE_REVISED` | (任意 relation/node) | (year/event) | yes(改訂履歴) |
| R339 | data_provenance | `:DATA_PROVENANCE` | (任意 master) | `:Text`/`:Site` | yes |
| R340 | last_audited_at | `:LAST_AUDITED_AT` | (任意 relation/node) | (year) | yes(Gemini 監査日) |

→ **R291-R340 で 50 種**(累計 290 + 50 = **340 種** で目標 300+ 達成)

### 15.2 既存 relation との整合

| 既存 | 拡張との関係 |
|---|---|
| `:SUPPORTS` (hypothesis → 任意) | R303 `:EVIDENCE_PRO` で **強度** 軸を追加 |
| `:CONTRADICTS` (hypothesis → 任意) | R304 `:EVIDENCE_CON` で **強度** 軸を追加 |
| `:PROPOSED_BY` (hypothesis → text/clan/emperor) | 既存。R293 `:HYPOTHESIS_PROPOSED_BY` を別形で記録(ID 命名のみ統一) |
| `:MERGED_INTO` (任意 → 任意) | 既存。本書では追加せず |

### 15.3 主要利用シナリオ

#### Scenario A. 邪馬台国畿内/九州論争

```
(HYP-畿内説)-[:HYPOTHESIS_LAYER]->("L2")
(HYP-九州説)-[:HYPOTHESIS_LAYER]->("L2")
(HYP-畿内説)-[:HYPOTHESIS_COMPETES_WITH]<->(HYP-九州説)
(SITE-纒向遺跡)-[:STRONG_EVIDENCE]->(HYP-畿内説)
(SITE-吉野ヶ里)-[:STRONG_EVIDENCE]->(HYP-九州説)
(TXT-魏志倭人伝)-[:TEXTUAL_EVIDENCE]->(HYP-畿内説)
(TXT-魏志倭人伝)-[:TEXTUAL_EVIDENCE]->(HYP-九州説)
(HYP-畿内説)-[:ACADEMIC_CONSENSUS]->("優勢だが未決")
(HYP-畿内説)-[:HYPOTHESIS_ALTERNATIVE_TO]<->(HYP-九州説)
```

#### Scenario B. ヤマタノオロチ製鉄民説の検証

```
(HYP-002 ヤマタノオロチ製鉄説)-[:HYPOTHESIS_LAYER]->("L4")
(HYP-002)-[:HYPOTHESIS_PROPOSED_BY]->(CLN-谷川健一)
(REG-斐伊川流域)-[:WEAK_EVIDENCE]->(HYP-002)
(SITE-奥出雲砂鉄文化)-[:INDIRECT_EVIDENCE]->(HYP-002)
(SITE-出雲弥生製鉄炉不在)-[:EVIDENCE_CON]->(HYP-002)
(HYP-002)-[:MINORITY_VIEW]->("民俗学界で言及される程度")
(HYP-002)-[:HYPOTHESIS_STATUS]->("L4 大胆仮説、考古学的反証あり")
(MWK-奥出雲たたら)-[:WEAK_EVIDENCE]->(HYP-002) ※近世以降の踏鞴文化のため弱い
```

#### Scenario C. 東日流外三郡誌の偽書認定

```
(TXT-東日流外三郡誌)-[:CONFIRMED_FORGERY]->("学術的に偽書認定")
(TXT-東日流外三郡誌)-[:FORGERY_PERIOD]->(RGE-昭和)
(TXT-東日流外三郡誌)-[:FORGERY_MOTIVE]->("地域アイデンティティ商業化")
(TXT-東日流外三郡誌)-[:FORGERY_INFLUENCES_BELIEF]->(HYP-アラハバキ縄文系神格説)
(HYP-アラハバキ縄文系神格説)-[:HYPOTHESIS_LAYER]->("L4")
(HYP-アラハバキ縄文系神格説)-[:PSEUDOHISTORY_SUPPORTED_BY]->(TXT-東日流外三郡誌)
(HYP-アラハバキ縄文系神格説)-[:HYPOTHESIS_COMPETES_WITH]<->(HYP-客人神後付け解釈説)
```

#### Scenario D. 国学→国家神道の連続性検証

```
(HYP-国学⇄国家神道連続性)-[:HYPOTHESIS_LAYER]->("L1")
(HYP-国学⇄国家神道連続性)-[:HYPOTHESIS_PROPOSED_BY]->(CLN-近代史学界)
(HYP-国学⇄国家神道連続性)-[:ACADEMIC_CONSENSUS]->("広く支持")
(CLN-本居宣長)-[:SCHOLAR_PROPOSED]->(HYP-古事記伝中心主義)
(CLN-平田篤胤)-[:SCHOLAR_PROPOSED]->(HYP-幽冥論)
(HYP-平田幽冥論)-[:HYPOTHESIS_EXTENDS]->(HYP-国学⇄国家神道連続性)
(HYP-国学⇄国家神道連続性)-[:ERA_SPECIFIC_VIEW]->(DPD-近代)
```

#### Scenario E. relation 自身のメタ情報(R331-R340 の利用)

```
※ R331-R340 は relation 自身のプロパティとしても使えるが、グラフ DB ではプロパティ運用が標準。
  本書では「relation 種類」として独立化し、強度・出典を明示するためのオプション。

例: (DEI-001 大国主)-[:ENSHRINED_AT {confidenceLevel:'A', mythologyLayer:'L0', sourceReference:'TXT-延喜式'}]->(SHR-001 出雲大社)
   ↑
   既存スキーマでは relation のプロパティとして実装。R331-R340 はその仕様文書化。

監査履歴の独立 relation 化 (R338, R340) は、本プロジェクト独自の運用機能:
(REL-RLN-12345)-[:CONFIDENCE_REVISED]->("CE 2026-04 Gemini監査により C → B")
(REL-RLN-12345)-[:LAST_AUDITED_AT]->("CE 2026-05")
```
...
| S08 考古・物質 | ✅ | 103 | 240 |
| S09 時間・継承 | ✅ | 103 | 290 |
| **S10 仮説・解釈** | **✅(本 PR)** | 103 | **340 ✓** |
| S11 strength/temporal/uncertainty 規程 | 未着手 | 103 | 340 |
| S12 全体整合性検証 | 未着手 | 103 | 340 |

→ **relation 拡張完了**:目標 300+ を達成(40 既存 + 300 新規 = 340 種)。
→ S11 で R331-R340 系の **運用ガイドライン**(プロパティ vs 独立 relation 化の判断)を整備、S12 で全体整合性を検証して issue #123 完結。

---

## 16. relation strength / temporal / uncertainty 規程(S11)

S05-S10 で追加した 300 relation の **強度・時間軸・不確実性** を実運用上どう扱うか規程する。

### 16.1 relation strength(関係強度)

#### 16.1.1 5 段階強度

| level | 名称 | 意味 | 適用例 |
|---|---|---|---|
| S5 | 確定 | 史料・考古双方で複数裏付け | DEI-001 大国主 → SHR-001 出雲大社(出雲国造神賀詞) |
| S4 | 強 | 史料記載+傍証 | 中央正史記載+地方社伝 |
| S3 | 中 | 一次史料 1 つ | 古事記単独記載 |
| S2 | 弱 | 二次史料・社伝・民俗 | 中世社伝のみ |
| S1 | 推定 | 仮説からの推測 | L4-L5 仮説に基づく派生関係 |

#### 16.1.2 confidence_level(A-E)との対応

| confidence_level | strength 目安 |
|---|---|
| A | S5 |
| B | S4 |
| C | S3 |
...
→ 既存 confidence_level (A-E) と 1:1 対応のため、**strength は冗長**。以下では confidence_level に統一する規約とし、独立 strength プロパティは **採用しない**。

### 16.2 temporal scope(時間範囲)

#### 16.2.1 7 種の時間スコープ

`#124` で詳細化される 5 時間軸 + 2 補助:

| value | 説明 |
|---|---|
| `mythic` | 神話時代(神代・神武即位前)、年代不明 |
| `estimated` | 学術的推定年代(古墳期、弥生中期 等) |
| `document` | 文献記載の確定年代(CE 712 古事記成立 等) |
| `ritual` | 祭祀的時間(神事の周期、暦) |
| `political` | 政治的時間(天皇治世、元号、王朝期) |
| `archaeological` | 考古学的時間(C14、層位、編年) |
| `literary` | 文学・テクスト時間(物語内年代) |

#### 16.2.2 valid_from / valid_until

数値西暦(CE 整数、BCE は負数):
- `valid_from = -660` → 神武即位伝(BCE 660)
- `valid_from = 712` → 古事記成立
- `valid_until = 1872` → 神仏分離令以前
- `valid_from = null` → 範囲不明

### 16.3 uncertainty handling(不確実性の扱い)

#### 16.3.1 3 軸の不確実性

| 軸 | プロパティ | 値 |
|---|---|---|
| 史実性 | `historicityLevel` | A-E |
| 仮説強度 | `hypothesisLayer` | L0-L5 |
| 出典確度 | `sourceReliability` | A-E |

→ 3 軸の **直積** で relation の不確実性を完全表現:

例: `:LINKED_TO_MYTH {historicityLevel:'C', hypothesisLayer:'L2', sourceReliability:'B'}`
→ 「神話的伝承(C)で、複数研究者言及(L2)、文献は中等確度(B)」

#### 16.3.2 不確実性の伝搬

- 連鎖 relation の不確実性は **最弱** をとる(min)
- 例: A → B → C で B が hypothesisLayer=L4 なら、A → C 経路全体は L4 として扱う
- Cypher クエリでは `MATCH p=(a)-[*]->(c) WHERE all(r in relationships(p) WHERE r.hypothesisLayer <= 'L2')` で confidence path のみ抽出

### 16.4 default property 規程

新規 relation 投入時の必須プロパティ(全 340 種共通):

```
relationId           STRING (RLN-NNNNNN)、ユニーク
sourceId             STRING (master_id)、必須
sourceType           STRING (node label)、必須
relationType         STRING (snake_case)、必須
targetId             STRING (master_id)、必須
targetType           STRING (node label)、必須
confidenceLevel      STRING (A-E)、必須
hypothesisLayer      STRING (L0-L5)、必須
sourceReference      STRING (text master_id or 自由記述)、必須
notes                STRING、任意
historicalLayer      STRING (mythic/estimated/document)、任意
mythologyLayer       STRING (L0-L5)、myth 系 relation で任意
temporalScope        STRING (上記 7 種)、任意
validFrom            INTEGER (CE 西暦)、任意
validUntil           INTEGER (CE 西暦)、任意
evidenceType         STRING (textual/archaeological/folkloric/comparative/inferred)、任意
lastAuditedAt        STRING (YYYY-MM)、任意
auditedBy            STRING (claude/gemini/human)、任意
```

### 16.5 directed / undirected の運用

Neo4j は内部的に常に directed:
- TSV `relation_type` に `_undirected` サフィックスは **付けない**(命名一貫性のため)
- undirected 意味の relation(`:SIBLING_OF` `:MARRIED_TO` `:SYNCRETIZED_WITH` 等)は **片方向 1 行のみ保存**
- Cypher 検索は `MATCH (a)-[r:SIBLING_OF]-(b)` で無向検索

### 16.6 relation 命名衝突回避ガイドライン

新規 relation 追加時:
1. 既存 340 種(`docs/schema/02_relation_types.md` 40 + 本書 §10-§15 R41-R340)と **完全一致** する名称は禁止
2. プレフィックス重複(:HOLDS_*, :LINKED_*) は **OK**(意味の異なる場合)
3. 新規追加時は本書 §16 ステータスチェックを通過させる
4. 監査(`docs/audit/`)で重複検出スクリプトを定期実行

### 16.7 relation 廃止規程

廃止 relation は **削除せず deprecated** とする:
- TSV カラムに `deprecated_at`(年)を追加
- Cypher 写像は残置(既存データ破壊防止)
- 代替 relation を `replaced_by` プロパティで明示
...
[既存 13 node]
   │
   ├── 神格・神社・氏族・皇族・神話エピソード・歴史事象・遺跡・遺物・祭祀・地域・文献・仮説・称号
   │
[本書 90 新規 node]
   │
   ├── 神話文化層 30(motif/cosmology/sacred_*/divine_*/symbol/mythic_*)— S02
   ├── 祭祀ネットワーク層 30(pilgrimage/festival/oracle/lineage/role/school/architecture)— S03
   └── 政治・物的層 30(battle/treaty/migration/route/workshop/capital/tax/era/burial)— S04
```

### 17.3 拡張 relation の意味的構造

```
[既存 40 relation]
   │
   ├── 神社祭祀 5 / 系譜 6 / 神格同体 5 / 政治支配 6 / 神話出来事 4 / 文献出典 3 / 考古 3 / 祭祀 3 / 仮説 3 / メタ 2
   │
[本書 300 新規 relation]
   │
   ├── 神話派生 50(motif evolution/migration/syncretism/localization/politicalization)— S05
   ├── 祭祀権力 50(priest hierarchy/shrine network/festival/pilgrimage/oracle)— S06
   ├── 政治・支配 50(battle/treaty/migration/court/tax)— S07
   ├── 考古・物質 50(stratification/typology/sacred correspondence/workshop/myth linkage)— S08
   ├── 時間・継承 50(precedence/inheritance/textual chain/rupture/prophecy)— S09
   └── 仮説・解釈 50(structure/evidence/scholarly/forgery/confidence)— S10
```

### 17.4 主要利用シナリオの再集計

S05-S10 で計 **23 シナリオ** の実例化(各 §10.5/§11.3/§12.3/§13.3/§14.3/§15.3 参照):

| シナリオ群 | サブタスク | 数 |
|---|---|---|
| 国譲り視点反転 / 八幡本地垂迹 / 蛇神地域化 / 大物主祟り政治化 | S05 | 4 |
| 諏訪二重制 / 八幡神社系統 / 神在祭 / 熊野詣 / 宇佐託宣 | S06 | 5 |
| 壬申の乱 / 神賀詞条約 / 神武東征 / 律令制 | S07 | 4 |
| 銅鐸祭祀 / 七支刀 / 奥出雲たたら / 沖ノ島 | S08 | 4 |
| 1872 神仏分離 / 縄文連続 / 編纂連鎖 / 大物主因果 / 元号天皇 | S09 | 5 |
| 邪馬台国論争 / オロチ製鉄説検証 / 東日流偽書 / 国学→国家神道 / メタ情報 | S10 | 5 |

→ **27 シナリオすべてが本書 103 node × 340 relation で表現可能**

### 17.5 docs/schema/ との最終整合確認

| schema 文書 | 本書整合 | 改訂要否 |
|---|---|---|
| `00_id_scheme.md` | ✅ 既存プレフィックス継承 + 21+ 新規プレフィックス予約 | 任意(本書を参照する形で残す) |
| `01_node_types.md` | ✅ 13 node 不変、本書 §1.1-§9 で 90 追加提案 | 任意 |
| `02_relation_types.md` | ✅ 40 relation 不変、本書 §10-§15 で 300 追加提案 | 任意 |
| `03-05_*_master_design.md` | ✅ 既存設計不変 | 不要 |
| `06_time_axes.md` | ✅ 5 軸+ ↔ 本書 §16.2、`#124` で詳細化 | `#124` で更新 |
| `07_source_reliability.md` | ✅ A-E 継承 | 不要 |
| `08_hypothesis_layer.md` | ✅ L0-L5 継承、L5 超は `#124` | `#124` で更新 |
| `09_relation_db.md` | ✅ 必須カラム継承 + 本書 §16.4 拡張プロパティ | 任意 |
| `10_future_architectures.md` | ✅ 本書全体 + `#125` で具体化 | 不要 |

### 17.6 既存データとの後方互換性

- **既存 motif_db.tsv (245)**: MTF プレフィックスの新規 node に拡張可。MOTIF-001 そのまま継承
- **既存 02_motif_relations.tsv (620)**: 既存 8 relation_type は本書 R41-R90(新規 50)と整合(`:DERIVED_FROM_MOTIF` などへ写像可)
- **既存 deity_master / shrine_master / clan_master**: 既存 13 node 不変なので影響なし

### 17.7 後続 issue への引き継ぎ事項

- **#124**(時間構造 + 仮説層)で本書 §16.2-§16.3 を詳細化、`docs/schema/06_time_axes.md` / `08_hypothesis_layer.md` を更新
- **#125**(Neo4j 拡張)で本書 103 node × 340 relation の Cypher 写像表(`docs/civilization/10_neo4j_extended.md`)を作成
- **#127**(100+ Epic)で本書のサブグラフを Epic 単位に切り出す
- **#137**(relation_table 5000+)で本書 relation 種を実データに適用

### 17.8 結論

| 達成項目 | 状態 |
|---|---|
| node 100+ 目標(target 100) | ✅ **103 種 達成** |
| relation 300+ 目標(target 300) | ✅ **340 種 達成** |
| 既存 schema 完全継承 | ✅ |
| 既存 motif_db / motif_relations 後方互換 | ✅ |
| 命名衝突 0 | ✅ |
| 利用シナリオ 27 件で網羅性検証 | ✅ |
| 後続 issue (#124/#125/#127/#137) 引き継ぎ準備 | ✅ |

→ **issue #123 全 12 サブタスク完了**。1700+ 行のスキーマ拡張設計確定。
...
| S02 node 拡張 第1群(神話文化層) | ✅ | 43 | 40 |
| S03 node 拡張 第2群(祭祀ネットワーク層) | ✅ | 73 | 40 |
| S04 node 拡張 第3群(政治・物的層) | ✅ | **103** | 40 |
| S05 relation 拡張 第1群(神話派生) | ✅ | 103 | 90 |
| S06 relation 拡張 第2群(祭祀権力) | ✅ | 103 | 140 |
| S07 relation 拡張 第3群(政治・支配) | ✅ | 103 | 190 |
| S08 relation 拡張 第4群(考古・物質) | ✅ | 103 | 240 |
| S09 relation 拡張 第5群(時間・継承) | ✅ | 103 | 290 |
| S10 relation 拡張 第6群(仮説・解釈) | ✅ | 103 | **340** |
| **S11 strength/temporal/uncertainty 規程** | **✅(本 PR)** | 103 | 340 |
| **S12 全体整合性検証** | **✅(本 PR)** | 103 | 340 |
